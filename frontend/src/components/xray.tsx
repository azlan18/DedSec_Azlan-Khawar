  ...
  const handleDownloadCSV = () => {
    ...
    const csv = "Finding,Probability\n" + 
      Object.entries(predictions)
        .map(([label, prob]) => `${label},${prob.toFixed(4)}`)
        .join("\n");
    ...
    <div className="container mx-auto py-12 px-4 sm:px-6 lg:px-8">
      <div className="text-center space-y-4 mb-12">
        ...
        <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
          Upload a chest X-ray image for automated disease detection and AI-assisted analysis using advanced machine learning
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
        <Card className="shadow-lg">
          <CardHeader>
            <CardTitle className="text-2xl">Upload X-Ray Image</CardTitle>
          ...
          <CardContent>
            {loading ? (
                  ...
                  <div className="prose prose-lg prose-slate dark:prose-invert max-w-none">
                    {aiAnalysis ? (
                      ...
                      <p className="text-muted-foreground italic text-base">
                        No AI analysis available. Please analyze an X-ray image first.
                      </p>
                    )}
                  </div>
                </TabsContent>
              ...
              <div className="flex flex-col items-center justify-center h-80 text-center">
                <Stethoscope className="h-12 w-12 text-primary/50 mb-4" />
                <p className="text-lg text-muted-foreground">
                  Upload and analyze an X-ray to see the results
                </p>
              </div>
            )}
          </CardContent>
      ...
      <Card className="shadow-lg">
        ...
        <CardContent>
          <p className="text-lg text-muted-foreground">
            This X-ray analysis tool uses a DenseNet121 model trained on chest X-rays to detect 14 different conditions. 
